                ...
                <div class="admin-control">
                    ...
                    <div class="admin-control-center">
                        <form action="" class="form-search">
                            ...
                            <input id="form-search-product" type="text" class="form-search-input" placeholder="Tìm kiếm sách giáo khoa..." oninput="showProduct()">
                        </form>
                    </div>
            ...
            <div class="section">
                <div class="admin-control">
                    ...
                    <div class="admin-control-center">
                        <form action="" class="form-search">
                            <span class="search-btn"><i class="fa-light fa-magnifying-glass"></i></span>
                            <input id="form-search-tk" type="text" class="form-search-input" placeholder="Tìm kiếm sách giáo khoa..." oninput="thongKe()">
                        </form>
                    </div>
                    <div class="admin-control-right">
                        <form action="" class="fillter-date">
            ...
            <div class="form-content sign-up">
                <form action="" class="signup-form">
                    <div class="form-group">
                        ...
                        <input id="fullname" name="fullname" type="text" placeholder="VD: Đỗ Nguyễn Thiên" class="form-control">
